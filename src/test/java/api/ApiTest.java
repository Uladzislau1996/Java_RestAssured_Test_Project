...
public class ApiTest {
    ...
    @Test (description = "1 Check that Avatar contains ID" +
            "2 Check that email ends with reqres.in")
    ...
    @Test (description = "Проверить не успешную регистрацию")
    ...
    @Test (description = "Проверить сортировку возраста от меньшего к большему")
    ...
    public void timeTest(){
        Specifications.installSpecification(Specifications.requestSpec(URL), Specifications.responseSpecOK200());
        UserTime user = new UserTime("mprpheus", "zion president");
